...
${OBJECTDIR}/src/PSOThread.o: src/PSOThread.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PSOThread.o src/PSOThread.cpp

${OBJECTDIR}/src/PSO_Interface.o: src/PSO_Interface.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PSO_Interface.o src/PSO_Interface.cpp
...
${OBJECTDIR}/src/UserInterface.o: src/UserInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UserInterface.o src/UserInterface.cpp
...
${OBJECTDIR}/src/pso.o: src/pso.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pso.o src/pso.cpp
